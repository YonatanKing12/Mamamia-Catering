/**
 * BackToTop — 03 §13.3 ("delete `bg-golden` and `rounded-full`; keep the control").
 *
 * ─────────────────────────────────────────────────────────────────────
 *  מה נמחק מהגרסה הקודמת, ולמה
 * ─────────────────────────────────────────────────────────────────────
 *  · `bg-golden` / `hover:bg-dark-golden` — 2.25:1. הטוקן עצמו נמחק (§2.1).
 *  · `rounded-full` — L-11: הרדיוס בבית הזה הוא 3px. הגליל היחיד הוא ה־tag.
 *  · `shadow-lg` + `hover-lift` — L-8: אין צללים, ואין הרמה של 10px.
 ...
 *  · `left-8` — L-12: תכונה פיזית. `start-8` הוא inset-inline-start,
