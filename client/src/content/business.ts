...
export const SLOTS = {
   ...
   *   2. **האם כל שלושת הסניפים.** התשובה נמסרה על העסק ולא לכל סניף
   *      בנפרד. הוחלה כאן על שלושתם — אם סניף אחד שונה, יש לתקן מיד.
   *
   * TODO(owner): שם הגוף המכשיר המלא, העתק תעודה בתוקף, ואישור שהיא
   * חלה על שלושת הסניפים.
   */
  kashrutByBranch: {
